        ...
        return request(myRequest)
            .then(function (response) {
                ...
                var expectedStacklaData = {
                    ...
                    stacklaTrackingPixelImg: '<img src="https://stp.stack.la/record.png?product_id=013742002799M&event=add_to_wishlist&ext_currency=USD&ext_quantity=1&ext_price=30" width="1px" height="1px" />'
